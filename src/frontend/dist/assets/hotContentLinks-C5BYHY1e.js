import { a9 as React, r as reactExports, W as useReducedMotion, aa as getMotionDuration, j as jsxRuntimeExports, ab as TooltipProvider, ac as Tooltip, ad as TooltipTrigger, ae as TooltipContent } from "./index-BY4GfDKL.js";
...
function DemandHeatMap({ locations }) {
  const containerRef = reactExports.useRef(null);
  const [_dimensions, setDimensions] = reactExports.useState({ width: 0, height: 0 });
  ...
  const coordBounds = locationsWithCoords.length > 0 ? {
    minLat: Math.min(
  ...
  const getPositionForLocation = (locationName, index) => {
    let hash = 0;
  ...
  const getCoordinatePosition = (coords) => {
    ...
    const x = lonRange === 0 ? 50 : (coords.longitude - coordBounds.minLon) / lonRange * 80 + 10;
    const y = latRange === 0 ? 50 : (coordBounds.maxLat - coords.latitude) / latRange * 80 + 10;
    return { x, y };
  };
  ...
  const getHeatColor = (normalizedDemand) => {
  ...
  const getHeatSize = (normalizedDemand) => {
    return 20 + normalizedDemand / 100 * 40;
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-6 rounded-lg border bg-muted/30 p-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium", children: "Demand Level:" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Medium" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Very High" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-background/60" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipProvider, { children: normalizedLocations.map((location, index) => {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        ...
                        children: /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "h-4 w-4 text-white" })
                      }
                    )
                  ]
                }
              ) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold", children: location.location }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
                  "Demand Score: ",
                  Number(location.demandScore)
                ] })
              ] }) })
            ] }, location.location);
          }) }),
          locations.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "No demand data available" }) })
        ]
      }
    )
  ] });
}
const hotContentLinks = {
  tiktok: "https://www.tiktok.com/search?q=kenya%20land%20property",
  instagram: "https://www.instagram.com/explore/tags/kenyaland/",
  x: "https://twitter.com/search?q=kenya%20land%20property",
  facebook: "https://www.facebook.com/search/top?q=kenya%20land%20property"
};
export {
  DemandHeatMap as D,
  SiTiktok as S,
